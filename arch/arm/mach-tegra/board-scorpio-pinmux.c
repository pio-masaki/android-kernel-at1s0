/*
 * arch/arm/mach-tegra/board-scorpio-pinmux.c
 *
...
static __initdata struct tegra_drive_pingroup_config scorpio_drive_pinmux[] = {
	DEFAULT_DRIVE(DDC),
	DEFAULT_DRIVE(VI1),
//	DEFAULT_DRIVE(SDIO1),
...
//	SET_DRIVE(DDC,		DISABLE, ENABLE, DIV_1, 31, 31, FASTEST, FASTEST),
	...
	SET_DRIVE(LCD1,		DISABLE, ENABLE, DIV_4, 31, 31, FASTEST, FASTEST),
	SET_DRIVE(LCD2,		DISABLE, ENABLE, DIV_4, 31, 31, FASTEST, FASTEST),
	SET_DRIVE(SDIO1,	DISABLE, ENABLE, DIV_4, 31, 31, SLOWEST, SLOWEST),
	SET_DRIVE(SDMMC3,	DISABLE, ENABLE, DIV_4, 22, 22, SLOWEST, SLOWEST),
};

static __initdata struct tegra_pingroup_config scorpio_pinmux[] = {
	...
	{TEGRA_PINGROUP_LDI,   TEGRA_MUX_DISPLAYA,      TEGRA_PUPD_NORMAL,    TEGRA_TRI_TRISTATE},
	{TEGRA_PINGROUP_LHP0,  TEGRA_MUX_DISPLAYA,      TEGRA_PUPD_NORMAL,    TEGRA_TRI_TRISTATE},
	{TEGRA_PINGROUP_LHP1,  TEGRA_MUX_DISPLAYA,      TEGRA_PUPD_NORMAL,    TEGRA_TRI_TRISTATE},
	{TEGRA_PINGROUP_LHP2,  TEGRA_MUX_DISPLAYA,      TEGRA_PUPD_NORMAL,    TEGRA_TRI_TRISTATE},
	...
	{TEGRA_PINGROUP_LPP,   TEGRA_MUX_DISPLAYA,      TEGRA_PUPD_NORMAL,    TEGRA_TRI_TRISTATE},
	...
	{TEGRA_PINGROUP_LVP1,  TEGRA_MUX_DISPLAYA,      TEGRA_PUPD_NORMAL,    TEGRA_TRI_TRISTATE},
...
static struct tegra_gpio_table gpio_table[] = {
	...
	{ .gpio = TEGRA_GPIO_EXT_HP_DET,	.enable = true  },
	{ .gpio = TEGRA_GPIO_INT_SPKR_EN,       .enable = true  },
	{ .gpio = TEGRA_GPIO_AMIC_EN,           .enable = true  },
	{ .gpio = TEGRA_GPIO_AMIC_DET,          .enable = true  },
};

int __init scorpio_pinmux_init(void)
{
	tegra_pinmux_config_table(scorpio_pinmux, ARRAY_SIZE(scorpio_pinmux));
	tegra_drive_pinmux_config_table(scorpio_drive_pinmux,
					ARRAY_SIZE(scorpio_drive_pinmux));
