...
/* WM8903 GPIOs */
#define ANTARES_GPIO_WM8903(_x_)	(TCA6416_GPIO_END + 1 + (_x_))
#define ANTAREO_GPIO_WM8903_END		ANTARES_GPIO_WM8903(4)

/* Audio-related GPIOs */
#define TEGRA_GPIO_CDC_IRQ		TEGRA_GPIO_PX3
#define TEGRA_GPIO_SPKR_EN		ANTARES_GPIO_WM8903(2)
